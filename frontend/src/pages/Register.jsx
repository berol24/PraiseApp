      ...
      <div className="relative z-10 w-full max-w-md animate-slideUp">
        <div className="bg-white/90 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-sm">Rejoignez la communauté PraiseApp</p>
          </div>
          ...
          <p className="mt-6 text-center text-gray-600 text-sm">
            Déjà un compte ?{" "}
            <Link to="/login" className="font-semibold text-blue-700 hover:text-blue-800 hover:underline transition-colors flex items-center justify-center gap-1">
              Se connecter
